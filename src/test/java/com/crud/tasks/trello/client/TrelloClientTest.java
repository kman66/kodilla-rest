...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        Mockito.when(trelloConfig.getUsername()).thenReturn("karol930");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/karol930/boards?key=test&token=test&fields=name,id&lists=all");
    ...
    public void shouldCreateCard() throws URISyntaxException {
        ...
        assertEquals(badgeOfCard, newCard.getBadges());
    }
